...
// 	protoc        (unknown)
// source: security/authn/jwt/v1/config.proto
...
func (x *Config) Reset() {
	*x = Config{}
	mi := &file_security_authn_jwt_v1_config_proto_msgTypes[0]
...
func (*Config) Descriptor() ([]byte, []int) {
	return file_security_authn_jwt_v1_config_proto_rawDescGZIP(), []int{0}
}
...
var File_security_authn_jwt_v1_config_proto protoreflect.FileDescriptor

const file_security_authn_jwt_v1_config_proto_rawDesc = "" +
	"\n" +
	"\"security/authn/jwt/v1/config.proto\x12!contrib.api.security.authn.jwt.v1\x1a$gnostic/openapi/v3/annotations.proto\x1a\x17validate/validate.proto\"\x9e\a\n" +
	...
	"\r_token_sourceB\xa4\x02\n" +
	"%com.contrib.api.security.authn.jwt.v1B\vConfigProtoP\x01ZCgithub.com/origadmin/contrib/api/gen/go/security/authn/jwt/v1;jwtv1\xa2\x02\x05CASAJ\xaa\x02!Contrib.Api.Security.Authn.Jwt.V1\xca\x02!Contrib\\Api\\Security\\Authn\\Jwt\\V1\xe2\x02-Contrib\\Api\\Security\\Authn\\Jwt\\V1\\GPBMetadata\xea\x02&Contrib::Api::Security::Authn::Jwt::V1b\x06proto3"

var (
	file_security_authn_jwt_v1_config_proto_rawDescOnce sync.Once
	file_security_authn_jwt_v1_config_proto_rawDescData []byte
)

func file_security_authn_jwt_v1_config_proto_rawDescGZIP() []byte {
	file_security_authn_jwt_v1_config_proto_rawDescOnce.Do(func() {
		file_security_authn_jwt_v1_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_security_authn_jwt_v1_config_proto_rawDesc), len(file_security_authn_jwt_v1_config_proto_rawDesc)))
	})
	return file_security_authn_jwt_v1_config_proto_rawDescData
}

var file_security_authn_jwt_v1_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_security_authn_jwt_v1_config_proto_goTypes = []any{
	(*Config)(nil), // 0: contrib.api.security.authn.jwt.v1.Config
}
var file_security_authn_jwt_v1_config_proto_depIdxs = []int32{
...
func init() { file_security_authn_jwt_v1_config_proto_init() }
func file_security_authn_jwt_v1_config_proto_init() {
	if File_security_authn_jwt_v1_config_proto != nil {
		return
	}
	file_security_authn_jwt_v1_config_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_security_authn_jwt_v1_config_proto_rawDesc), len(file_security_authn_jwt_v1_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_security_authn_jwt_v1_config_proto_goTypes,
		DependencyIndexes: file_security_authn_jwt_v1_config_proto_depIdxs,
		MessageInfos:      file_security_authn_jwt_v1_config_proto_msgTypes,
	}.Build()
	File_security_authn_jwt_v1_config_proto = out.File
	file_security_authn_jwt_v1_config_proto_goTypes = nil
	file_security_authn_jwt_v1_config_proto_depIdxs = nil
}
