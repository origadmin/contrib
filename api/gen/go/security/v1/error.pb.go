...
const file_security_v1_error_proto_rawDesc = "" +
	"\n" +
	"\x17security/v1/error.proto\x12\x17contrib.api.security.v1\x1a\x13errors/errors.proto*\xd5\x02\n" +
	...
	"\x11PERMISSION_DENIED\x10\xd0\x0f\x1a\x04\xa8E\x93\x03\x1a\x04\xa0E\xf4\x03B\xe8\x01\n" +
	"\x1bcom.contrib.api.security.v1B\n" +
	"ErrorProtoP\x01Z>github.com/origadmin/contrib/api/gen/go/security/v1;securityv1\xa2\x02\x03CAS\xaa\x02\x17Contrib.Api.Security.V1\xca\x02\x17Contrib\\Api\\Security\\V1\xe2\x02#Contrib\\Api\\Security\\V1\\GPBMetadata\xea\x02\x1aContrib::Api::Security::V1b\x06proto3"
...
var file_security_v1_error_proto_goTypes = []any{
	(SecurityErrorReason)(0), // 0: contrib.api.security.v1.SecurityErrorReason
}
