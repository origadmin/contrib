...
// 	protoc        (unknown)
// source: security/v1/principal.proto
...
func (x *Principal) Reset() {
	*x = Principal{}
	mi := &file_security_v1_principal_proto_msgTypes[0]
...
func (*Principal) Descriptor() ([]byte, []int) {
	return file_security_v1_principal_proto_rawDescGZIP(), []int{0}
}
...
const file_security_v1_principal_proto_rawDesc = "" +
	...
	"\x05value\x18\x02 \x01(\v2\x16.google.protobuf.ValueR\x05value:\x028\x01B\xec\x01\n" +
	"\x1bcom.contrib.api.security.v1B\x0ePrincipalProtoP\x01Z>github.com/origadmin/contrib/api/gen/go/security/v1;securityv1\xa2\x02\x03CAS\xaa\x02\x17Contrib.Api.Security.V1\xca\x02\x17Contrib\\Api\\Security\\V1\xe2\x02#Contrib\\Api\\Security\\V1\\GPBMetadata\xea\x02\x1aContrib::Api::Security::V1b\x06proto3"

var (
	file_security_v1_principal_proto_rawDescOnce sync.Once
	file_security_v1_principal_proto_rawDescData []byte
)

func file_security_v1_principal_proto_rawDescGZIP() []byte {
	file_security_v1_principal_proto_rawDescOnce.Do(func() {
		file_security_v1_principal_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_security_v1_principal_proto_rawDesc), len(file_security_v1_principal_proto_rawDesc)))
	})
	return file_security_v1_principal_proto_rawDescData
}

var file_security_v1_principal_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_security_v1_principal_proto_goTypes = []any{
	(*Principal)(nil),      // 0: contrib.api.security.v1.Principal
	nil,                    // 1: contrib.api.security.v1.Principal.ScopesEntry
	nil,                    // 2: contrib.api.security.v1.Principal.ClaimsEntry
	(*structpb.Value)(nil), // 3: google.protobuf.Value
}
var file_security_v1_principal_proto_depIdxs = []int32{
	1, // 0: contrib.api.security.v1.Principal.scopes:type_name -> contrib.api.security.v1.Principal.ScopesEntry
	2, // 1: contrib.api.security.v1.Principal.claims:type_name -> contrib.api.security.v1.Principal.ClaimsEntry
	3, // 2: contrib.api.security.v1.Principal.ClaimsEntry.value:type_name -> google.protobuf.Value
...
func init() { file_security_v1_principal_proto_init() }
func file_security_v1_principal_proto_init() {
	if File_security_v1_principal_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_security_v1_principal_proto_rawDesc), len(file_security_v1_principal_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_security_v1_principal_proto_goTypes,
		DependencyIndexes: file_security_v1_principal_proto_depIdxs,
		MessageInfos:      file_security_v1_principal_proto_msgTypes,
	}.Build()
	File_security_v1_principal_proto = out.File
	file_security_v1_principal_proto_goTypes = nil
	file_security_v1_principal_proto_depIdxs = nil
}
