...
import (
	...
	storagev1 "github.com/origadmin/contrib/api/gen/go/config/data/cache/v1"
...
func New(ss ...StorageOption) securityToken.CacheStorage { // Use securityToken.CacheStorage
